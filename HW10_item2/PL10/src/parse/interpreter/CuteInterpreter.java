...
public class CuteInterpreter {
    static Hashtable hashtable = new Hashtable<String, Node>();
    public static void main(String[] args) {
        ...
        while(true) {
            ...
            System.out.println(nodePrinter.prettyPrint());
        }
    }
    ...
    private Node lookuptable(String key){
        return (Node)hashtable.get(key);
    }
